...
namespace clipr.Converters
{
    ...
    /// supports both IPv4 and IPv6 addresses, but prefers an IPv6 address during
    ...
    /// </summary>
    public class IPHostConverterPreferIPv6 : IPHostConverter
    {
        /// <summary>
        /// This TypeConverter takes a String and converts it into an IPEndpoint.
        /// This class is similar to the <see cref="IPEndPointConverter"/> except
        ...
        /// port and IPv6 component.
        /// </summary>
        public IPHostConverterPreferIPv6()
            : base(IPPreference.IPv6)
        {
        }
        ...
        public IPHostConverterPreferIPv6(int defaultPort)
            : base(defaultPort, IPPreference.IPv6)
        {
        }
    }
}
